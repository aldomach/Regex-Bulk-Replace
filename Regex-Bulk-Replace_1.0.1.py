...
# --- Contenedor para la etiqueta y los botones ---
...
# Botón "Copiar" entre la etiqueta y "Guardar Resultado"
...
# Botón "Guardar Resultado" al final
...
texto_salida = scrolledtext.ScrolledText(root, height=15, width=80)  # Removido state=tk.DISABLED
